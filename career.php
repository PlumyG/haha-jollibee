...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="css/rotatingmain.css">
   ...
   <body>
      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-md-4">
               <h3 class="my-3">HaHa Pizza Ltd.</h3>
         ...
         <h3 class="my-4">Certificates & Award</h3>
		 <!-- certificates display -->
         <div class="row">
            <div class="col-lg-12 mb-4">
               <div id="wrap">
                  <div id="showcase" class="noselect"> 
                     <img class="cloud9-item" id="bh-1" width="35%;" src="images/cert1.jpg" alt="certificates"> 
                     <img class="cloud9-item" id="bh-2" width="25%;" src="images/cert2.jpg" alt="certificates"> 
                     <img class="cloud9-item" id="bh-3" width="25%;" src="images/cert3.jpg" alt="certificates"> 
                     <img class="cloud9-item" id="bh-4" width="35%;" src="images/cert4.jpg" alt="certificates"> 
                     <img class="cloud9-item" id="bh-5" width="35%;" src="images/cert5.jpg" alt="certificates"> 
                     <img class="cloud9-item" id="bh-6" width="35%;" src="images/cert6.jpg" alt="certificates"> 
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="col-lg-8 mb-4">
               ...
               <form name="sentMessage" id="contactForm" novalidate>
                  ...
                  <div class="control-group form-group">
                     <div class="controls">
                        <label>CV:</label>
                        <input type="file" class="form-control" id="cvupload" required data-validation-required-message="Please upload your cv.">
                     </div>
                  </div>
                  <div id="success"></div>
