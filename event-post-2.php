...
<html lang="en">
   ...
   <body>
      ...
      <h1 class="mt-4 mb-3">Birthday Discount
      </h1>
      <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item">
            <a href="event-home.php">Event</a>
         </li>
         <li class="breadcrumb-item active">Birthday Discount</li>
      </ol>
      <div class="row">
         <!-- Post Content Column -->
         <div class="col-lg-8">
            <!-- Preview Image -->
            <img class="img-fluid rounded" src="images/event2.jpg" alt="">
            <hr>
            <!-- Date/Time -->
